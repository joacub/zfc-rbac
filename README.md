...
> If you are looking for older version of ZfjRbac, please refer to the 0.2.x branch.
> If you are using ZfjRbac 1.0, please upgrade to 2.0.
...
ZfjRbac only officially supports installation through Composer. For Composer documentation, please refer to
...
Enable the module by adding `ZfjRbac` key to your `application.config.php` file. Customize the module by copy-pasting
